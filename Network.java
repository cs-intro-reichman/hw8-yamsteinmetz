...
public class Network {
    ...
    public String mostPopularUser() {
        ...
        return (maxUser != null) ? maxUser.getName() : null;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.userCount; i++) {
            if (this.users[i] != null) {
                ans.append("\n").append(this.users[i].getName()).append(" -> ");
                String[] followees = this.users[i].getfFollows();
                for (int j = 0; j < this.users[i].getfCount(); j++) {
                    ans.append(followees[j]);
                    if (j < this.users[i].getfCount() - 1) {
                        ans.append(" ");
                    }
                }
            }
